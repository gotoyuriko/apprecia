...
export default function EditEnvironment({
    ...
    roomNo, setRoomNo,
    setOpenModalEnv }: EditEnvironmentProps) {
    const deleteRoomHandle = (roomNumber: number) => {
        ...
        const newRoomNo = roomNo === roomNumber ? (updatedTourRooms[0].room_id as number) : roomNo;

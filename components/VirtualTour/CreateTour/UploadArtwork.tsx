...
export default function UploadArtwork({
    ...
    const handleSelectArtwork = (url: string) => {
        setSelectPanel((prev) => prev ? { ...prev, src: url } : prev);
    ...
    const handleDeleteArtwork = () => {
        setSelectPanel((prev) => prev ? { ...prev, src: '' } : prev);
        setTourData((prevTourData) => {
            const updatedRoomArtwork = prevTourData.tour_room.map((room) => {
                if (room.room_id === roomNo) {
                    const updatedArtwork = room.room_artwork.map((artworkItem) => {
                    ...
                    <div className="flex items-center justify-between pb-5">
                        ...
                        <div className="flex">
                            ...
                            <button
                                ...
                                onClick={() => selectedImage && handleSelectArtwork(selectedImage)}

...
interface ArtworkModalProps {
    ...
    open: boolean;
    tourUser: AppUser | null;
    showDesc: ArtProject | null;
    viewsNo: number;
    setViewsNo: Dispatch<SetStateAction<number>>;
...
export default function ArtworkModal({
    ...
    useEffect(() => {
        if (currentUser) {
            setIsLiked(showDesc?.project_likedBy?.includes(currentUser.uid) ?? false);
        }
